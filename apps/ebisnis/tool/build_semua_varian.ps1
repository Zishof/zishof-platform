...
$variants = @(
    ...
    @{ Kode='abchicken';       Flavor='abchicken';      Target='lib/main_abchicken.dart';          Define='abchicken';       Iss='installer/abchicken.iss';       Apk='app-abchicken-release.apk';      Setup="AB-Chicken-Setup-$versi.exe" },

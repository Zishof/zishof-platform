...
$variants = @(
    ...
    @{ Kode='nahl';             Flavor='nahl';            Target='lib/main_nahl.dart';               Define='nahl';             Iss='installer/nahl.iss';             Apk='app-nahl-release.apk';            Setup="FF-Fajrul-Falah-Mart-Setup-$versi.exe" },

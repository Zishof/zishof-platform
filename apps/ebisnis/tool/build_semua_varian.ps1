...
$variants = @(
    ...
    @{ Kode='nahl';             Flavor='nahl';            Target='lib/main_nahl.dart';               Define='nahl';             Iss='installer/nahl.iss';             Apk='app-nahl-release.apk';            Setup="Al-Bahjah-An-Nahl-POS-Setup-$versi.exe" },

...
[Files]
Source: "..\build\windows\x64\runner\Release\*"; Excludes: "ebisnis_albahjah.exe,ebisnis_inventory_sales.exe,ebisnis_apotik.exe,ebisnis_emedik.exe,ebisnis_nahl.exe,ebisnis_petra.exe"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs

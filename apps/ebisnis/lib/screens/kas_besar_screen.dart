...
class _KasBesarScreenState extends State<KasBesarScreen> {
  ...
  /// hanya ditandai, supaya datanya masih bisa dilihat dan dipulihkan.
  ...
  int get _jumlahTerhapus => _data.where((b) => b['_dihapusLokal'] == true).length;
  ...
  Map<String, dynamic> _payloadDari(Map<String, dynamic> b) => {
        'satuanKerjaId': (b['satuanKerjaId'] as num?)?.toInt() ?? 0,
        'nama': '${b['nama'] ?? ''}',
        'jenisKasBesarId': (b['jenisKasBesarId'] as num?)?.toInt() ?? 0,
        'ambilDariKasKecil': b['ambilDariKasKecil'] == true,
        'kasKecilId': (b['kasKecilId'] as num?)?.toInt() ?? 0,
        'tanggal': '${b['tanggal'] ?? ''}',
  ...
  AppTableCell _aksiBaris(Map<String, dynamic> b) {
    ...
    return AppTableCell(
      ...
      child: Row(mainAxisSize: MainAxisSize.min, children: [
        ...
        if (b['_dihapusLokal'] != true && _boleh('approve') && !terkunci && status != 'Disetujui')
          IconButton(
            visualDensity: VisualDensity.compact,
            tooltip: 'Setujui',
        ...
        if (b['_dihapusLokal'] != true && _boleh('reject') && !terkunci && status != 'Ditolak')
          IconButton(
            visualDensity: VisualDensity.compact,
            tooltip: 'Tolak',
        ...
        if (b['_dihapusLokal'] != true && _boleh('delete') && !terkunci)
          IconButton(
            visualDensity: VisualDensity.compact,
              ...
              : _galat != null
                  ...
                  : AppDataTable(
                      ...
                      emptyText: _tampilkanTerhapus
                          ? 'Tidak ada dokumen yang ditandai terhapus di perangkat ini.'

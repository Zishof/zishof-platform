...
class PenggantianKasKecilScreen extends StatefulWidget {
  ...
  @override
  State<PenggantianKasKecilScreen> createState() =>
      _PenggantianKasKecilScreenState();
}
  ...
  Future<void> _form([Map<String, dynamic>? baris]) async {
    ...
    Future<bool> simpanData() async {
      ...
      return _kirimLokalDulu(
        ...
        kunci: ubah
            ? 'penggantian_kas_kecil:${baris['id']}'
            : 'penggantian_kas_kecil:baru:$idLokal',
        idLokal: idLokal,
        rowLokal: {
      ...
      builder: (c) => StatefulBuilder(
        builder: (c, setDialog) {
          Future<void> hitung() async {
            try {
              final res = await ApiClient.instance
                  .aksi('penggantian_kas_kecil_hitung', {'rincian': rincian});
              setDialog(() {
          ...
          return AlertDialog(
            title: Text(ubah
                ? 'Ubah Penggantian Kas Kecil'
                : 'Penggantian Kas Kecil Baru'),
            content: SizedBox(
              width: 660,
                  ...
                  onPressed: _sibuk
                      ...
                      : () async {
                          if (await _konfirmasi(
                              ...
                              'Ajukan')) {
                            await _kirimLokalDulu(
                                'penggantian_kas_kecil_ajukan_transfer',
                                {'id': b['id']},
            ...
            onPressed: _sibuk
                ...
                : () async {
                    if (await _konfirmasi(
                        ...
                        'Setujui')) {
                      await _kirimLokalDulu(
                          'penggantian_kas_kecil_setujui', {'id': b['id']},
                          kunci: 'penggantian_kas_kecil:${b['id']}',
            ...
            onPressed: _sibuk
                ...
                : () async {
                    if (await _konfirmasi('Tolak pengeluaran?',
                        '${b['kode']} — ${b['nama']}', 'Tolak')) {
                      await _kirimLokalDulu(
                          'penggantian_kas_kecil_tolak', {'id': b['id']},
                          kunci: 'penggantian_kas_kecil:${b['id']}',

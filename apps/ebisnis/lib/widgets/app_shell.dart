...
const _kunciAksesMenu = <MenuEBisnis, String>{
  ...
  MenuEBisnis.produksiQualityAlert: 'produksi_quality_alert',
...
const _kunciMenuKeuangan = <MenuEBisnis, String>{
  ...
  MenuEBisnis.prosesTransitori: 'proses_transitori',
  MenuEBisnis.nomorSuratKeuangan: 'nomor_surat_keuangan',
  MenuEBisnis.closing: 'closing',
};
...
const _daftarMenu = <_ItemMenuShell>[
  ...
  _ItemMenuShell(MenuEBisnis.produksiQualityAlert, Icons.verified_outlined,
      'Quality Alert (QC)',
      builder: _bangunProduksiQualityAlert),
  ...
  _ItemMenuShell(MenuEBisnis.prosesTransitori, Icons.swap_horiz_outlined,
      'Proses Transitori',
      builder: _bangunProsesTransitori),
  _ItemMenuShell(MenuEBisnis.nomorSuratKeuangan, Icons.numbers_outlined,
      'Penomoran Dokumen Keuangan',
      builder: _bangunNomorSuratKeuangan),
  _ItemMenuShell(MenuEBisnis.closing, Icons.event_available_outlined, 'Closing',
      builder: _bangunClosing),
...
Widget _bangunProduksiQualityAlert(BuildContext c) =>
    const ProduksiScreen(bagian: BagianProduksi.qualityAlert);
...
String _labelDrawer(MenuEBisnis kunci) {
  switch (kunci) {
    ...
    case MenuEBisnis.produksiQualityAlert:
      return 'Quality Alert (QC)';
    ...
    case MenuEBisnis.prosesTransitori:
      return 'Proses Transitori';
    case MenuEBisnis.nomorSuratKeuangan:
      return 'Penomoran Dokumen Keuangan';
    case MenuEBisnis.closing:
      return 'Closing';
...
MenuEBisnis? _menuDariLabel(String label) {
  switch (label) {
    ...
    case 'Dana Talangan':
      return MenuEBisnis.danaTalangan;
    case 'Reimbursement Pegawai':
    ...
    case 'Proses Transitori':
      return MenuEBisnis.prosesTransitori;
    case 'Penomoran Dokumen Keuangan':
      return MenuEBisnis.nomorSuratKeuangan;
    case 'Closing':
      return MenuEBisnis.closing;

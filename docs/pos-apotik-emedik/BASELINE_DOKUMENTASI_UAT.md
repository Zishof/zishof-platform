...
Dokumentasi hanya boleh dipublikasikan setelah Word, PDF, dan PPTX lulus pemeriksaan visual penuh, seluruh diagram bebas overlap, narasi unik dan relevan, tidak ada label jumlah kata, tidak ada data sensitif, serta tautan/versi/checksum sesuai dengan artefak rilis.
